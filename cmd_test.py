...
sup_esq_value = number_value(output, "sup_esq_")
sup_dir_value = number_value(output, "sup_dir_")
inf_dir_value = number_value(output, "inf_dir_")
inf_esq_value = signal_value(output)
